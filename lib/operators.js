...
// For a given pipeline, each operator is constructed by
// calling:
//
//   ```new operators[operator name](args)```
//
// ...where operator name is the name of the operator,
// and args is a string array of the input arguments
// to the operator.
//
// The constructed operator will then be treated as a
// readable and writable stream i.e. a readable stream will
// pipe data into it, and a writable stream will be piped
// from it. The data piped in will be a stringified JSON
// object of the form:
//
