...
var operators = {
  incsv: function(args) {
    var argv = optimist
      .options({
        b: {alias: 'doublequote', default: false, boolean: true},
        d: {alias: 'delimiter', default: ','},
        e: {alias: 'encoding', default: 'utf-8'},
        p: {alias: 'escapechar', default: '\\'},
        q: {alias: 'quotechar', default: '\"'},
        t: {alias: 'tabs', default: false, boolean: true},
        S: {alias: 'skipinitialspace', default: false, boolean: true},
      })
      .parse(args)
    ;
    if (argv.t) {
    ...
    if (argv.b) {
      // doublequote switch overrides escapechar opt
      argv.p = '\"';
    }
    return csv()
      .from.options({
